...
export const ProjectCard = ({ title, description, imageSrc, link, index, isVisible, isFlipped, onFlip, onSpecialClick }) => {
    ...
    return (_jsx("div", { className: `flip-card ${isFlipped ? 'flipped' : ''} ${isVisible ? 'visible' : ''}`, onClick: handleCardClick, onMouseEnter: onFlip, onMouseLeave: onFlip, "data-index": index, children: _jsxs("div", { className: "flip-card-inner", children: [_jsx("div", { className: "flip-card-front", children: _jsx("h3", { className: "project-title", children: title }) }), _jsxs("div", { className: "flip-card-back", children: [_jsx("div", { className: "card-image-banner", style: { backgroundImage: `url(${imageSrc})` } }), _jsxs("div", { className: "card-content-area", children: [_jsx("p", { className: "project-description", children: description }), _jsx("a", { href: link, className: "about-button", target: "_blank", rel: "noopener noreferrer", onClick: handleButtonClick, children: "About" })] })] })] }) }));
};
